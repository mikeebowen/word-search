...
module.exports = function (wordSearch, wordList, callback) {
  fs.readFile(wordSearch, 'utf8', function (err, search) {
    ...
    fs.readFile(wordList, 'utf8', function (err, list) {
      ...
      var reverseDiagStr = diagonalStr.split('').reverse().join('');
      for (var i = 0; i < testWordsArray.length; i++) {
      ...
      var reverseVertStr = verticalStr.split('').reverse().join('');
      for (var i = 0; i < testWordsArray.length; i++) {
      ...
      // Search the vertical string backwards
      var reverseStr = horizontalStr.split('').reverse().join('');
      for (var i = 0; i < testWordsArray.length; i++) {
